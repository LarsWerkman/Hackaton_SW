...
public class WeatherClock extends View {
	...
	public void init(AttributeSet attrs, int defStyle) {
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.WeatherClock, defStyle, 0);
		final Resources b = getContext().getResources();

		mWheelRadius = a.getDimensionPixelSize(
				R.styleable.WeatherClock_weather_wheel_radius,
				b.getDimensionPixelSize(R.dimen.weather_wheel_radius));
		mPrefererWheelRadius = mWheelRadius;
		mPointerRadius = a.getDimensionPixelSize(
				R.styleable.WeatherClock_weather_pointer_radius,
				b.getDimensionPixelSize(R.dimen.pointer_radius));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mWheelRectangle.set(-mWheelRadius, -mWheelRadius,
				mWheelRadius, mWheelRadius);
	}
